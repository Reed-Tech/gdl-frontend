...
const BannerBlog = () => {
    return (
        <div className='bannerBlog d-flex'>
            <div className="col-lg-7 col-sm-12 bannerBlog_text">
                ...
                <Button bsPrefix='btn px-5 btn-light font-weight-bold' variant='light' className='rounded-pill'>INVEST NOW</Button>
            </div>
